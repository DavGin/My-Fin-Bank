...
import { fetchRateByNumeroPratica, getFinanziamento } from '../../features/Finanziamenti/api'; // assicurati che siano importati
...
export default function FinanziamentoDetailPage() {
    ...
    // 🔁 Esegui refresh automatico ogni 10 secondi
    useEffect(() => {
