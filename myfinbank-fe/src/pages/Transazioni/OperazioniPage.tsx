...
// ✅ Tipo dedicato al form (evita mismatch con API/backend)
//
...
//
// ✅ Schema Yup coerente con il tipo sopra
//
...
export default function OperazioniPage() {
    ...
    //
    // ✅ useForm tipizzato con il tipo corretto
    //
    const {
        register,
        control,
    ...
    //
    // ✅ Funzione per formattare IBAN (gruppi di 4 caratteri)
    //
    ...
    //
    // 🧾 Prima del submit, apri riepilogo
    //
    ...
    //
    // 🚀 Conferma operazione e invia al backend
    //
    const confermaOperazione = () => {
        if (!datiRiepilogo) return;

        const payload: CreateTransactionInput = {
            id: 0, // se generato dal backend, puoi mettere 0 o rimuoverlo nel backend
            importo: datiRiepilogo.importo,
            descrizione: datiRiepilogo.descrizione,
            data: new Date().toISOString(),
            dataTransazione: new Date().toISOString(), // o una data distinta se necessario
            ...
            targetIban:
                datiRiepilogo.tipoTransazione === "BONIFICO"
                    ...
                    : "", // BONIFICO obbligatorio, altrimenti stringa vuota
        };
