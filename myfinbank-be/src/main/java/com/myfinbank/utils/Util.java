...
public class Util {
    ...
    /**
     * Metodo per generare un IBAN basato sui dati forniti.
     *
     * @param countryCode  Codice del paese (es. "IT").
     * @param bankCode     Codice identificativo della banca.
     * @param branchCode   Codice della filiale.
     * @param accountNumber Numero del conto.
     * @return IBAN valido secondo lo standard.
     */
